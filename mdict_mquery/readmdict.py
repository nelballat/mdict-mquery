    ...
    def get_index(self, check_block=True):
        ...
        for compressed_size, decompressed_size in record_block_info_list:
            ...
            while i < len(self._key_list):
                ...
                i += 1
                if check_block:
                    record_block[record_start - offset:record_end - offset]
    ...
    def _decode_record_block(self):
        ...
        for compressed_size, decompressed_size in record_block_info_list:
            ...
            while i < len(self._key_list):
                ...
                record = record.decode(self._encoding, errors='ignore').strip('\x00').encode('utf-8')
...
if __name__ == '__main__':
    ...
    if ext.lower() == os.path.extsep + 'mdx':
        ...
        bfname = args.filename.encode('utf-8') if isinstance(args.filename, str) else args.filename
        print('======== %s ========' % bfname)
    ...
    if os.path.exists(mdd_filename):
        ...
        bfname = mdd_filename.encode('utf-8') if isinstance(mdd_filename, str) else mdd_filename
        print('======== %s ========' % bfname)
